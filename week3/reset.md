...
You might have noticed in the [examples from last week](../week2/readme.md) a small margin running around default elements and anything positioned at `margin-left:0px;`. This is due to how browsers maintain default styles for most html elements, including the `<body>`.
...
The reset also ensure `box-sizing` is set appropriately.
...
Now that we've reset the page, we can advance to [making a grid system](grid.md).
